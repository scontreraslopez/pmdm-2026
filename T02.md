...
Kotlin apareció oficialmente (primera versión estable) en 2016, aunque su desarrollo comenzó en 2011. Este lenguaje fue creado por JetBrains, la empresa detrás del popular IDE IntelliJ IDEA, con un objetivo claro: evolucionar Java manteniendo su compatibilidad.
...
También encontramos la plataforma de elearning de **Hyperskill** que es el lugar donde Jetbrains publica sus cursos oficiales de Kotlin y Android, algunos de ellos gratuitos. Es un recurso muy valioso para profundizar en el lenguaje y sus aplicaciones prácticas.
