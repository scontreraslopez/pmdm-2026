...
4. Inicializa el repositorio de git. Abre la terminal integrada de Android Studio y ejecuta:
...
5. Crea un repo privado en GitHub dentro de tu organización de Móvil 2026.
...
6. Haz un commit inicial y súbelo a tu repo de GitHub:
